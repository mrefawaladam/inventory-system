...
$(document).ready(function() {
    ...
    const transferTable = $('#transfer-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            ...
            dataSrc: function(json) {
                $('#transfer-table tbody').find('.table-loading-overlay').remove();
                return json.data;
            }
        },
        columns: [
    ...
    transferTable.on('processing.dt', function(e, settings, processing) {
        if (processing) {
                    ...
                    <tr class="table-loading-overlay-row">
                        <td colspan="8" style="position: relative; height: 300px; padding: 0;">
                            <div class="table-loading-overlay">
                                ...
                                <div class="loading-text">Memuat data transaksi transfer...</div>
                            </div>
                        </td>
                    </tr>
                `);
            ...
            $('#transfer-table tbody').find('.table-loading-overlay-row').remove();
        }
    });
});
</script>
